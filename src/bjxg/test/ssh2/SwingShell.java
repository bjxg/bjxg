 ...
 *  - Verifying server hostkeys with an existing known_hosts file - Displaying
 * fingerprints of server hostkeys - Adding a server hostkey to a known_hosts file
 * (+hashing the hostname for security) - Authentication with DSA, RSA, password and
...
public class SwingShell {
    ...
    class TerminalDialog extends JDialog {
        ...
        public TerminalDialog(JFrame parent, String title, Session sess, int x,
            ...
            /*
             * This is a hack. We cannot disable the caret, since setting editable to
             * false also changes the meaning of the TAB key - and I want to use it
             * in bash. Again - this is a simple DEMO terminal =)
             */
    ...
    class InteractiveLogic implements InteractiveCallback {
        ...
        public String[] replyToChallenge(String name, String instruction,
            ...
            for (int i = 0; i < numPrompts; i++) {
                ...
                String[] content = new String[] { lastError, name, instruction,
                        prompt[i] };
                ...
                EnterSomethingDialog esd = new EnterSomethingDialog(loginFrame,
                        "Keyboard Interactive Authentication", content,
                        !echo[i]);
            ...
            try {
                ...
                while (true) {
                    if ((enableDSA || enableRSA)
                            && conn
                                    .isAuthMethodAvailable(username,
                                            "publickey")) {
                        if (enableDSA) {
                        ...
                        if (enableRSA) {
                            ...
                            if (key.exists()) {
                                EnterSomethingDialog esd = new EnterSomethingDialog(
                                        ...
                                        "RSA Authentication",
                                        new String[] { lastError,
                                                "Enter RSA private key password:" },
                                        true);
                                esd.setVisible(true);
                    ...
                    if (enableKeyboardInteractive
                        ...
                        if (il.getPromptCount() == 0) {
                            ...
                            enableKeyboardInteractive = false; // do not try this
                                                                // again
                        }
                        else {
                    ...
                    if (conn.isAuthMethodAvailable(username, "password")) {
                        final EnterSomethingDialog esd = new EnterSomethingDialog(
                                loginFrame, "Password Authentication",
                                new String[] { lastError,
                        ...
                        lastError = "Password authentication failed."; // try again,
                                                                        // if
                                                                        // possible
                ...
                TerminalDialog td = new TerminalDialog(loginFrame, username
                        + "@" + hostname, sess, x_width, y_width);
                ...
                // e.printStackTrace();
                JOptionPane.showMessageDialog(loginFrame, "Exception: "
                        + e.getMessage());
            }
